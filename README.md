...
**状态栏**：实时显示三平台已用百分比，颜色随最高百分比变化。

![状态栏](docs/screenshots/menubar.png)

**Popup 面板**：点击状态栏图标展开，查看各平台 5h 窗口配额、重置倒计时与刷新状态。

![Popup](docs/screenshots/popup.png)

**设置面板**：配置 API Key、调节颜色阈值、设置 Bark 推送与刷新频率。
...
本项目由 cc 独立设计与实现，未直接引用第三方开源代码。若发现任何遗漏的参考来源，欢迎提交 issue 指正。
